/*
    ...
    $Id: sad_altivec.c,v 1.1 2002/05/01 17:41:45 wmaycisco Exp $
    $Source: /cvsroot/mpeg4ip/mpeg4ip/lib/xvid/motion/ppc_asm/Attic/sad_altivec.c,v $
    $Date: 2002/05/01 17:41:45 $
    $Author: wmaycisco $
