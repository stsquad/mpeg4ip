...
/****************************************************************************
   ...
   Functions:         define global variables that are the interface of PEZW
                      module and other parts of MPEG4 code.
...
unsigned char **bits_to_go_inBuffer;
...
int spatial_leveloff;

/* reate control parameters */
unsigned char **reach_budget;
