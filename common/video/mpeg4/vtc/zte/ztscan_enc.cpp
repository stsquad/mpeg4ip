/* $Id: ztscan_enc.cpp,v 1.1 2001/02/05 20:26:21 cahighlander Exp $ */
/****************************************************************************/
...
#define DEFINE_ZTSCAN_GLOBALS 1
...
#if 0
	encode_pixel_SQ_tree(h,w);           /* LH */
	encode_pixel_SQ_tree(h+dc_h,w-dc_w); /* HL */
	encode_pixel_SQ_tree(h+dc_h,w);      /* HH */
#endif
