...
public:
	...
	Void dump (FILE* pf, const CRct& rct = CRct (), Int iScale = 255) const;
	Void dumpWithMask (FILE* pf, const CU8Image *puciMask, const CRct& rct = CRct (), Int iScale = 255) const;
...
*/
	...
	Void decimateBinaryShapeFrom (const CU8Image& uciSrc); // decimate by rateX and rateY in a conservative way
