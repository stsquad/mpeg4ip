...
int STDCALL decore(unsigned long key, unsigned long opt,
	...
	case ENC_OPT_INIT :
		{
			...
			xparam.rc_period = eparam->rc_period;
			xparam.rc_reaction_period = eparam->rc_reaction_period;
			xparam.rc_reaction_ratio = eparam->rc_reaction_ratio;
			...
			xparam.motion_search = eparam->quality;
			xparam.lum_masking = 0;
			xparam.quant_type = 0;
