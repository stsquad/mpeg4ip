...
static __inline unsigned int mpeg3slice_getbit(mpeg3_slice_buffer_t *buffer)
{
	if(buffer->bits_size)
...
static __inline unsigned int mpeg3slice_getbits2(mpeg3_slice_buffer_t *buffer)
{
...
static __inline unsigned int mpeg3slice_getbyte(mpeg3_slice_buffer_t *buffer)
{
...
static __inline unsigned int mpeg3slice_getbits(mpeg3_slice_buffer_t *slice_buffer, int bits)
{
...
static __inline unsigned int mpeg3slice_showbits16(mpeg3_slice_buffer_t *buffer)
{
...
static __inline unsigned int mpeg3slice_showbits9(mpeg3_slice_buffer_t *buffer)
{
...
static __inline unsigned int mpeg3slice_showbits5(mpeg3_slice_buffer_t *buffer)
{
...
static __inline unsigned int mpeg3slice_showbits(mpeg3_slice_buffer_t *slice_buffer, int bits)
{
	mpeg3slice_fillbits(slice_buffer, bits);
	return (slice_buffer->bits >> (slice_buffer->bits_size - bits)) & (0xffffffff >> (32 - bits));
}
