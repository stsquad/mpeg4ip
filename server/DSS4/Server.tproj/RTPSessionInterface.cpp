...
: 	QTSSDictionary(QTSSDictionaryMap::GetMap(QTSSDictionaryMap::kClientSessionDictIndex), NULL),
	...
	fOverbufferWindow(QTSServerInterface::GetServer()->GetPrefs()->GetSendIntervalInMsec(), 0, QTSServerInterface::GetServer()->GetPrefs()->GetMaxSendAheadTimeInSecs()),
...
void RTPSessionInterface::CreateDigestAuthenticationNonce() {
	...
	MD5_Update(&ctxt, (unsigned char *)":", 1);
