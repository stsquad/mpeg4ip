...
//		RTSPSourceInfo* rtspSourceInfo = dynamic_cast<RTSPSourceInfo *>(inInfo);
		RTSPSourceInfo* rtspSourceInfo = (RTSPSourceInfo *)(inInfo);
		Assert(rtspSourceInfo != NULL);
//		RTSPSourceInfo* sessionSourceInfo = dynamic_cast<RTSPSourceInfo *>(inRelaySession->GetSourceInfo());
...
QTSS_Error	RelayOutput::WritePacket(StrPtrLen* inPacket, void* inStreamCookie, UInt32 inFlags, SInt64 /*packetLatenessInMSec*/, SInt64* /*timeToSendThisPacketAgain*/ )
{
