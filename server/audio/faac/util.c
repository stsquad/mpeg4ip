 ...
 *
 * $Id: util.c,v 1.3 2001/06/28 23:54:23 wmaycisco Exp $
 */
...
/* Returns whether or not we're on a big-endian machine */
int IsBigEndian(void)
{
    union {
        unsigned long longval;
        char charval[sizeof(unsigned long)];
    } u;

    u.longval = 0x41424344L;  /* ABCD in ASCII */
	return (u.charval[0] == 'A');
}
