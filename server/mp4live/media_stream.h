...
DECLARE_CONFIG(STREAM_VIDEO_SRTP_ALGO);
...
DECLARE_CONFIG(STREAM_VIDEO_SRTP_KDR);
...
DECLARE_CONFIG(STREAM_AUDIO_SRTP_ALGO);
...
DECLARE_CONFIG(STREAM_AUDIO_SRTP_KDR);
...
DECLARE_CONFIG(STREAM_TEXT_SRTP_ALGO);
...
DECLARE_CONFIG(STREAM_TEXT_SRTP_KDR);
...
static SConfigVariable StreamConfigVariables[] = {
  ...
  CONFIG_INT(STREAM_VIDEO_SRTP_ALGO, "videoSRTPAlgorithm", 0),
  ...
  CONFIG_INT(STREAM_VIDEO_SRTP_KDR, "videoSrtpKdr", 16),
  ...
  CONFIG_INT(STREAM_AUDIO_SRTP_ALGO, "audioSRTPAlgorithm", 0),
  ...
  CONFIG_INT(STREAM_AUDIO_SRTP_KDR, "audioSrtpKdr", 16),
  ...
  CONFIG_INT(STREAM_TEXT_SRTP_ALGO, "textSRTPAlgorithm", 0),
  ...
  CONFIG_INT(STREAM_TEXT_SRTP_KDR, "textSrtpKdr", 16),
