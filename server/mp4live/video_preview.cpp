...
int CVideoPreview::ThreadMain(void) 
{
...
void CVideoPreview::DoStartPreview()
{
	if (m_preview) {
		return;
	}
...
void CVideoPreview::DoStopPreview()
{
	if (!m_preview) {
		return;
	}
...
void CVideoPreview::DoPreviewFrame(CMediaFrame* pFrame)
{
	if (pFrame == NULL) {
		return;
	}
