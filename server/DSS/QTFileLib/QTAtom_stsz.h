 ...
 */
// $Id: QTAtom_stsz.h,v 1.1 2001/02/27 00:56:49 cahighlander Exp $
//
// QTAtom_stsz:
...
public:
	...
	virtual	Bool16		SampleRangeSize(UInt32 firstSampleNumber, UInt32 lastSampleNumber, UInt32 *sizePtr);
