 ...
 */
// $Id: QTAtom_tref.cpp,v 1.1 2001/02/27 00:56:49 cahighlander Exp $
//
// QTAtom_tref:
...
Bool16 QTAtom_tref::Initialize(void)
{
	...
	if( ((UInt32)fTrackReferenceTable & (UInt32)0x3) == 0)
		fTable = (UInt32 *)fTrackReferenceTable;
	else
		fTable = (UInt32 *)(((UInt32)fTrackReferenceTable + 4) & ~((UInt32)0x3));
