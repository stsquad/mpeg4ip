...
public:
	...
	inline UInt32 GetPacketSourceID();
...
public:
	...
	inline UInt32 GetReportSourceID(int inReportNum);
	 ...
	 UInt8 GetTotalLostPackets(int inReportNum);
...
inline UInt32 RTCPPacket::GetPacketSourceID()
{
...
inline UInt8 RTCPReceiverPacket::GetTotalLostPackets(int inReportNum)
{
	return (UInt8) ( ntohl(*(UInt32*)&fRTCPReceiverReportArray[this->RecordOffset(inReportNum)+kTotalLostPacketsOffset]) & kTotalLostPacketsMask );
}
