...
#pragma mark __QTSS_SERVER_CONTROL_MODULE__
...
#pragma mark __SERVER_CONTROL_FUNCTIONS__
...
void QTSSvrControlThread::HistoryEntry()
{
	...
	QTSSModuleUtils::GetPref(sPrefs, "history_update_interval", qtssAttrDataTypeUInt32,
