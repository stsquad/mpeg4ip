...
static const UINT8 intra_MCBPC_code[4] = { 1, 1, 2, 3 };
static const UINT8 intra_MCBPC_bits[4] = { 1, 3, 3, 3 };

/* inter MCBPC, mb_type = 0 then 3 */
static const UINT8 inter_MCBPC_code[8] = { 1, 3, 2, 5, 3, 4, 3, 3 };
static const UINT8 inter_MCBPC_bits[8] = { 1, 4, 4, 6, 5, 8, 8, 7 };
